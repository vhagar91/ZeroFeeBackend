...
from .views import UserViewList, ProfileViewGet, ProfilePictureUpdate, AddUserView
...
urlpatterns = [
   ...
   url(r'^new/$', AddUserView.as_view(serializer_class=UserSerializer),name='new-user'),
